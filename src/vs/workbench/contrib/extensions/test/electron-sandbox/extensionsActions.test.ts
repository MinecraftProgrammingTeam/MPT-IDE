...
suite('ReloadAction', () => {
	...
	test('Test ReloadAction when extension is newly installed', async () => {
		...
		await promise;
		assert.ok(testObject.enabled);
		assert.strictEqual(testObject.tooltip, 'Please reload MPT-IDE to enable this extension.');
	});
	...
	test('Test ReloadAction when extension is uninstalled', async () => {
		...
		didUninstallEvent.fire({ identifier: local.identifier });
		assert.ok(testObject.enabled);
		assert.strictEqual(testObject.tooltip, 'Please reload MPT-IDE to complete the uninstallation of this extension.');
	});
	...
	test('Test ReloadAction when extension is updated while running', async () => {
		...
		return new Promise<void>(c => {
			disposables.add(testObject.onDidChange(() => {
				if (testObject.enabled && testObject.tooltip === 'Please reload MPT-IDE to enable the updated extension.') {
					c();
				}
			}));
	...
	test('Test ReloadAction when extension is disabled when running', async () => {
		...
		assert.ok(testObject.enabled);
		assert.strictEqual('Please reload MPT-IDE to disable this extension.', testObject.tooltip);
	});
	...
	test('Test ReloadAction when extension is enabled when not running', async () => {
		...
		await testObject.update();
		assert.ok(testObject.enabled);
		assert.strictEqual('Please reload MPT-IDE to enable this extension.', testObject.tooltip);
	});
